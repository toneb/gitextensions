...
namespace GitUI
{
    public static class ThreadHelper
    {
        ...
        /// <summary>
        /// Asynchronously run <paramref name="joinableTask"/> on a background thread and forward all exceptions to <see cref="UiApplication.OnThreadException"/> except for <see cref="OperationCanceledException"/>, which is ignored.
        /// </summary>
