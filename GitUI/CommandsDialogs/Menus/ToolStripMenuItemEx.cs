...
namespace GitUI.CommandsDialogs.Menus
{
    ...
    internal abstract class ToolStripMenuItemExAvalonia : MenuItem, ITranslate
    {
        private Func<GitUICommands>? _getUICommands;
        ...
        /// <param name="hotkeys">The collection of configured shortcut keys.</param>
        /// <param name="commandCode">The required shortcut identifier.</param>
        internal static void SetShortcutKey(MenuItem menuItem, IEnumerable<HotkeyCommand>? hotkeys, int commandCode)
        {
            KeyGesture inputGesture = KeyGesture.Parse(GetShortcutKey(hotkeys, commandCode));
